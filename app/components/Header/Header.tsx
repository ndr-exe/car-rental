...
import ScrollToBookingFormButton from './ScrollToBookingFormButton';
        ...
        <div className="xs:max-w-[500px] mt-12 mx-auto med:mx-0 med:mr-auto">
          ...
          <div className="flex flex-col items-center gap-5 w-fit mx-auto xs:flex-row med:w-full med:justify-start ">
            <ScrollToBookingFormButton>
              <span className="px-20 py-[18px] font-bold button-primary flex items-center gap-2 border-2 border-primary xs:px-8 xs:py-5 ">
                Book Ride <Checked />
              </span>
            </ScrollToBookingFormButton>
            <a
