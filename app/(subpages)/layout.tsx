...
const subpagesLayout = ({
  ...
  return (
    <>
      <div className="absolute top-0 left-0 w-full h-[20rem] lg:h-[26rem] flex items-center subpageHeaderBg">
        <div className={`${poppins.className} px-6 container`}>
          <Breadcrumb />
        </div>
      </div>
      <main className="mt-[20rem] lg:mt-[26rem]">{children}</main>
      <div
